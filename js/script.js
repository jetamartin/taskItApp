...
//				console.log(taskList);
			...
			*/
			...
			var genericTaskItemHtml2 = '<div class="card"><div class="card-block"><div><a data-toggle="modal" data-target="#markCompleteConfirmModal"><label class="checkBoxLabel"><input class="checkbox" type="checkbox" id="" name="taskTitle" value="taskTitle">Completed?</label></a><a href="#"><span class="card-subtitle mb-2" for="">%taskTitle%</span></a></div><h6 class="card-text taskDue ">%date%</h6><h6 class="card-text">%repeatSymbol%%repeatOption%</h6><h6 class="taskListName clearBoth">%listName%</h6></div></div>'	
			
			var genericTaskItemHtml1 = '<div class="card"><div class="card-block"><div><a data-toggle="modal" data-target="#markCompleteConfirmModal"><label class="checkBoxLabel"><input class="checkbox" type="checkbox" id="" name="taskTitle" value="taskTitle">Completed?</label></a><span onclick="appUIController.displayEditTaskPage(this)" class="card-subtitle mb-2" data-id="%taskItemId%" for="">%taskTitle%</span></div><h6 class="card-text taskDue ">%date%</h6><h6 class="card-text">%repeatSymbol%%repeatOption%</h6><h6 class="taskListName clearBoth">%listName%</h6></div></div>'
			
			var genericTaskItemHtml = '<div class="card"><div class="card-block"><div><a data-toggle="modal" data-target="#markCompleteConfirmModal"><label class="checkBoxLabel"><input class="checkbox floatRight" type="checkbox" id="" name="taskTitle" value="taskTitle">Completed</label></a><span onclick="appUIController.displayEditTaskPage(this)" class="card-subtitle mb-2" data-id="%taskItemId%" for="">%taskTitle%</span></div><h6 class="card-text taskDue ">%date%</h6><h6 class="card-text">%repeatSymbol%%repeatOption%</h6><div><h6 class="taskListName floatLeft">School</h6><a data-toggle="modal" data-target="markToDelete"><label class="checkBoxLabel floatRight"><i class="fa fa-trash-o floatRight deleteTaskIcon" aria-hidden="true"></i>Delete Task</label></a></div></div>'
